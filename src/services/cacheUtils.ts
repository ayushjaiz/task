...
export class TaskCacheService {
    // Cache user's tasks
    static async cacheUserTasks(userId: string, tasks: any[]): Promise<void> {
    ...
    static async getUserTasks(userId: string): Promise<any[] | null> {
        const key = cacheService.generateKey(CACHE_KEYS.TASKS, userId);
    ...
    static async cacheTask(taskId: string, task: any): Promise<void> {
    ...
    static async getTaskWithSubtasks(taskId: string): Promise<{ task: any, subtasks: any[] } | null> {
    ...
    static async invalidateUserTasks(userId: string): Promise<void> {
        const key = cacheService.generateKey(CACHE_KEYS.TASKS, userId);
